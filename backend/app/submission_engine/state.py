    ...
    def __init__(self) -> None:
        ...
        self._transitions: dict[SubmissionState, list[SubmissionState]] = {
            ...
            SubmissionState.EXECUTING_FIELDS: [
                SubmissionState.EXECUTING_UPLOADS, SubmissionState.FAILED,
                SubmissionState.BLOCKED, SubmissionState.CANCELLED,
            ],
            SubmissionState.EXECUTING_UPLOADS: [
                SubmissionState.AWAITING_CONFIRMATION, SubmissionState.FAILED,
                SubmissionState.BLOCKED, SubmissionState.CANCELLED,
            ],
